 ...
 * @author hydrocat
 */
public class CadastrarCartaoVermelho extends javax.swing.JFrame {
     ...
     */
    public CadastrarCartaoVermelho(AssistenteConexao helper, int idJogo) {
        this.helper = helper;
        this.idJogo = idJogo;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for ( Component c : this.jPanel1.getComponents() )
        {
            ...
            if( cb.isSelected() )
            {
                ...
                new CartaoDAO(helper).inserirCartãoVermelho(
                        new Cartao(
                                p.getId()
                        )
                );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarCartaoVermelho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastrarCartaoVermelho( new AssistenteConexao(), 12).setVisible(true);
            }
        });
    }
