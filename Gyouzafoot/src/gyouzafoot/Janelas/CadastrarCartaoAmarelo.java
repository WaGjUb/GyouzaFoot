 ...
 * @author hydrocat
 */
public class CadastrarCartaoAmarelo extends javax.swing.JFrame {
     ...
     */
    public CadastrarCartaoAmarelo(AssistenteConexao helper, int idJogo) {
        this.helper = helper;
        this.idJogo = idJogo;
        ...
        try {
            ...
            {
                this.jPanel1.add( new PainelCheckBoxInt(j.getNome(), j.getId()) );
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {        
        PainelCheckBoxInt cb;
        for ( Component c : this.jPanel1.getComponents() )
        {
            cb = (PainelCheckBoxInt) c;
            if( cb.isSelected() )
            {
                new CartaoDAO(helper).inserirCartãoAmarelo(
                        new Cartao(
                                new ParticipacaoDAO(helper).buscar(
                                    cb.getNumero(),
                                    idJogo
                                ).getId()                
                        )
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarCartaoAmarelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastrarCartaoAmarelo( new AssistenteConexao(), 12).setVisible(true);
            }
        });
    }
